            ...
            <div class="card" style="margin-top: 0px;">
                ...
                <div class="card-body">
                    ...
                    <ul style="text-align:left;">
                        <li>
                            <strong
                                >On indefinite integrals, do I have to include
                                the constant of integration?</strong
                            >
                        </li>
                        <p>
                            Yes, include them.
                        ...
                        <p>
                            <a href="mailto:portughalam@gmail.com">Email me</a> and
                        ...
                        <p>Literally anything. You can put emojis, images, whatever.</p>
                    </ul>
                </div>
            </div>
        </div>
